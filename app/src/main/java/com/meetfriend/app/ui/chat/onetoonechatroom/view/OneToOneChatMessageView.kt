...
import com.meetfriend.app.databinding.ViewOneToOneChatMessageBinding
...
class OneToOneChatMessageView(context: Context, canSendMessage: Int) :
    ...
    private lateinit var binding: ViewOneToOneChatMessageBinding
    ...
    private fun inflateUi() {
        val view = View.inflate(context, R.layout.view_one_to_one_chat_message, this)
        layoutParams = LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT)
        binding = ViewOneToOneChatMessageBinding.bind(view)
