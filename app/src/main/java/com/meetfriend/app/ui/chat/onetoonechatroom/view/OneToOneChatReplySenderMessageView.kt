...
import com.meetfriend.app.databinding.ViewReplySenderMessageBinding
...
class OneToOneChatReplySenderMessageView(context: Context, canSendMessage: Int, profileImage: String?) :
    ...
    private lateinit var binding: ViewReplySenderMessageBinding
    ...
    private fun inflateUi() {
        val view = View.inflate(context, R.layout.view_reply_sender_message, this)
        layoutParams = LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT)
        binding = ViewReplySenderMessageBinding.bind(view)
