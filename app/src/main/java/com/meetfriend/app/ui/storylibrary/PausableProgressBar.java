package com.meetfriend.app.ui.storylibrary;
...
final class PausableProgressBar extends FrameLayout {
    ...
    void setMaxWithoutCallback() {
        maxProgressView.setBackgroundResource(R.color.color_tab_purple);
    ...
    private void finishProgress(boolean isMax) {
        if (isMax) maxProgressView.setBackgroundResource(R.color.color_tab_purple);
