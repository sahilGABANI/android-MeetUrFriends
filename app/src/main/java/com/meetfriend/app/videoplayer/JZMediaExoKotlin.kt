    ...
    override fun prepare() {
        ...
        mMediaHandler.post {
            ...
            if (simpleExoPlayer == null) {
                ...
                simpleExoPlayer?.videoScalingMode = C.VIDEO_SCALING_MODE_DEFAULT
            ...
            val mediaSource = if (currUrl.contains(".m3u8")) {
                HlsMediaSource.Factory(MeetFriend.cacheDataSourceFactory)
                ...
                ProgressiveMediaSource.Factory(MeetFriend.cacheDataSourceFactory)
